...
class LeasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lease" do
    assert_difference("Lease.count") do
      post leases_url, params: { lease: { monthly_rent: @lease.monthly_rent, room_id: @lease.room_id, start_date: @lease.start_date, tenant_id: @lease.tenant_id } }
    end
  ...
  test "should update lease" do
    patch lease_url(@lease), params: { lease: { monthly_rent: @lease.monthly_rent, room_id: @lease.room_id, start_date: @lease.start_date, tenant_id: @lease.tenant_id } }
